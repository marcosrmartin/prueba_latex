...
\newcommand{\titulo}{(Revisión/Mejora)? de un sistema de ciberdefensa dinámica basada en algoritmos evolutivos para la prevención de ataques informáticos}
\newcommand{\tituloEng}{Evolutionary Based Moving Target Cyberdefense System}
\newcommand{\autor}{Marcos Romero Martín}
\newcommand{\email}{marcos2001@correo.ugr.es}
